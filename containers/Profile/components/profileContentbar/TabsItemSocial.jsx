    ...
    <div className="flex  items-center justify-between flex-row py-5 md:py-0">
      ...
      <div className=" mx-1">
        <button
          ...
          type="button"
          className="flex items-center gap-2 font-semibold px-3 md:px-5 py-1 md:py-2 rounded-md transition-colors duration-150 hover:text-black/80  hover:bg-white/80 border border-transparent hover:border-white/20"
        >
          <span>Ekle</span><FaPlus />
        </button>
      </div>
    </div>
        ...
        <div className="flex justify-center flex-wrap gap-4">
          {posts.map((post, index) => (
            <button
              ...
              />
              {
                post.video_url && <MdOutlineVideoLibrary size={isMobile ? 20 : 30} className=" absolute top-2 right-2 text-white drop-shadow-[0_2px_2px_rgba(0,0,0,1)] group-hover:drop-shadow-[0_2px_2px_rgba(0,0,0,0.7)]" />
              }

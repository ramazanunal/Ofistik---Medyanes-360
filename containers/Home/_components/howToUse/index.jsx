        ...
        <div className="flex flex-row md:flex-col justify-around md:justify-normal">
          {datas.map((data) => (
            <div
              ...
              className={`md:mb-4 flex text-center md:text-left md:flex-col flex-row md:pl-4 md:pt-3 rounded-lg hover:cursor-pointer hover:bg-gray-200 hover:text-btnBg ${selectItemId === data.id ? "bg-[#f3f4f6] text-[#5636be] opacity-100 font-medium" : ""
                }`}
            >

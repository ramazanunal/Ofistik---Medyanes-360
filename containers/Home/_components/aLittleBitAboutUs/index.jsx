...
function ALitleBitAboutUs() {
  return (
      <div id="aLittleBitAboutUs" className="bg-deep-slate-blue w-full h-fit pt-36 py-20 flex items-center justify-center">
        <div className="mx-auto h-full flex flex-col w-4/6">
          ...
          <div className="grid grid-cols-2 justify-items-center gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 h-full">
            {data.map((item, idx) => (
